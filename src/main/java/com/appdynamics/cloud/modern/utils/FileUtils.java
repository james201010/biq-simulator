...
public class FileUtils {
    ...
    // returns an array with the file name in slot 0 and the extension in slot 1
...
//			
//			if (dir.exists() && dir.isDirectory() && dir.canRead()) {
//				FileNameExtensionFilter filter = new FileNameExtensionFilter(fileNamePattern);
