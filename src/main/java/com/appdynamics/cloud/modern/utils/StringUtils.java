...
//					}
	...
	/**
	 * Returns a file as a stream, the file path passed should adhere to one
	 * of the following formats in regard to line separators:
	 *
	 * D:\_data\stuff\myfile.txt
	 * D:/_data/stuff/myfile.txt
	 ...
	 * @throws Exception
	 */
	public static FileInputStream getFileAsStream(String filePath) throws Exception {
